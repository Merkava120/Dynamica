...
#################### ON EVENTS ######################
	def onKbdEvent(self, argsList):
        ...
        # merkava note: advc.007b removed the body of this function because BugEventManager handled it but I am not using Bug and platy uses this, hence, leaving it
